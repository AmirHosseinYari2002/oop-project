...
public class Hen extends DomesticAnimal{
    ...
    Product outProduct(TIME startDisappearTime) throws FileNotFoundException {
        return new Product(this.ManufacturedProduct,15,1,4,startDisappearTime,Manager.random.nextInt(Manager.mapWidth)+Manager.distanceMapAndPageWidth,Manager.random.nextInt(Manager.mapHeight)+Manager.distanceMapAndPageHeight);
    }
}
